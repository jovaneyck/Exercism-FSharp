...
let ``Surprise garden`` () =
    ...
    Assert.That(lookupPlants "Samantha" garden, Is.EqualTo([Plant.Violets; Plant.Clover; Plant.Radishes; Plant.Violets]))
    Assert.That(lookupPlants "Patricia" garden, Is.EqualTo([Plant.Radishes; Plant.Radishes; Plant.Grass; Plant.Clover]))
    Assert.That(lookupPlants "Xander" garden, Is.EqualTo([Plant.Grass; Plant.Violets; Plant.Clover; Plant.Grass]))
    Assert.That(lookupPlants "Roger" garden, Is.EqualTo([Plant.Radishes; Plant.Grass; Plant.Clover; Plant.Violets]))