...
[<Test>]
let ``Segments are split for a perfect square`` () =
    Assert.That(plaintextSegments "123456789", Is.EqualTo(["123"; "456"; "789"]))

[<Test>]
let ``Segments are split for an imperfect square`` () =
    Assert.That(plaintextSegments "12345678", Is.EqualTo(["123"; "456"; "78"]))
